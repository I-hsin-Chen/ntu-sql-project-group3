...
if __name__ == '__main__':
    ...
    # evaluation
    parser.add_argument('--get_cardinality', help='Get cardinality for a query', action='store_true')
    ...
    if args.get_cardinality:
        from cardinality import get_cardinality
        logging.info(
            f"maqp(get_cardinality: ensemble_location={args.ensemble_location}, physical_db_name={args.database_name}, query={args.query}, schema={schema}, rdc_spn_selection={args.rdc_spn_selection}, pairwise_rdc_path={args.pairwise_rdc_path}, use_generated_code={args.use_generated_code}, max_variants={args.max_variants}, merge_indicator_exp={args.merge_indicator_exp}, exploit_overlapping={args.exploit_overlapping})")
        get_cardinality(args.ensemble_location, args.query, schema, args.rdc_spn_selection,
                        args.pairwise_rdc_path, use_generated_code=args.use_generated_code, max_variants=args.max_variants,
                        merge_indicator_exp=args.merge_indicator_exp, exploit_overlapping=args.exploit_overlapping)
